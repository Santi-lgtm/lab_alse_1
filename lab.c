...
// a continuación se encuentran enlistados todos los prototipos utilizados para la realización de los procesos
...
void ingreso_datos(char valores1[VALOR_MAX]){
        ...
        printf("Por favor ingrese los valores de la siguiente manera: val1;val2;val3... \n");
        scanf("%s",valores1);
...
//aquí se realiza el calculo del promedio
...
{
       printf("por favor ingrese los numeros de la nueva cadena.\n\n");
       scanf("%s",valore);
}
